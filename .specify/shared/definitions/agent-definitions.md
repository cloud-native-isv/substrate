...
| **Agent tool-call list** | The `tools:` frontmatter key — the LLM's callable surface inside one agent | `.specify/agents/{templates,instances}/<slug>.agent.md` frontmatter |
