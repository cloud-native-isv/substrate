...
**Feature Count**: 18
**Last Reconciled**: 2026-08-06 (full-registry bootstrap from repo inventory)
...
| 014 | Wasm Sandbox Runtime        | WebAssembly sandbox backend plugged into the atelet/ateom lifecycle contract. (xuanji custom)                   | Draft       | .specify/memory/features/014.md        | 2026-08-06   |
...
| 015 | Workload Security Hardening | Authorization policies, dependency scanning/SBOM, threat-model-driven hardening beyond gVisor. (DFSec)          | Draft       | .specify/memory/features/015.md        | 2026-08-06   |
